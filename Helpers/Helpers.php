<?php 
        ...
        if(ENVIRONMENT == 1){
           ...
           //Create an instance; passing `true` enables exceptions
            ...
            try {
                ...
                $mail->Username   = '95juliandos@gmail.com';          //SMTP username
                $mail->Password   = 'Julian95';                               //SMTP password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                //Recipients
                $mail->setFrom('95juliandos@gmail.com', 'Servidor Local');
                ...
                return true; // Aquí debe ser false porque es como se valida si se envió del correo, pero lo dejo en true porque no funciona esta parte
            } 
        }
    }
    ...
    function sessionStart(){
		session_start();
        $inactive = 99999;// tiempo de sesion activa
